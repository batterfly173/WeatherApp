...
SWIFT_CLASS("_TtC7Weather11SearchAlert")
...
@interface SearchAlert (SWIFT_EXTENSION(Weather)) <UITextFieldDelegate>
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified feelsLikeTemperature;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified temperature;
...
@interface ViewController (SWIFT_EXTENSION(Weather)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
@end


SWIFT_CLASS("_TtC7Weather12VisualEffect")
@interface VisualEffect : UIView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
